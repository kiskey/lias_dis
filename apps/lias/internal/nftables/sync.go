...
func NewSync(b *Builder, p PolicyEvaluator, s ScheduleEvaluator, trigger chan struct{}) *Sync {
    return &Sync{
        builder: b,
        policy:  p,
        sched:   s,
...
// It resyncs immediately when triggered, and falls back to a 60-second
// periodic resync to catch schedule transitions.
